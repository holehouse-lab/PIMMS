...
def mega_crank(NUMPY_INT_TYPE[:,:,:] grid, 
    ...
    cdef cnp.ndarray[NUMPY_INT_TYPE, ndim=2] position_triptic = np.zeros([3, 3], dtype = NUMPY_INT_TYPE_PYTHON)    
    cdef cnp.ndarray[NUMPY_INT_TYPE, ndim=2] three_position_holder = np.zeros([3, 3], dtype = NUMPY_INT_TYPE_PYTHON)    
    cdef cnp.ndarray[NUMPY_INT_TYPE, ndim=2] two_position_holder = np.zeros([2, 3], dtype = NUMPY_INT_TYPE_PYTHON)    

    cdef cnp.ndarray[NUMPY_INT_TYPE, ndim=1] old_position = np.zeros([3], dtype = NUMPY_INT_TYPE_PYTHON)    
    cdef cnp.ndarray[NUMPY_INT_TYPE, ndim=1] anchor_bead = np.zeros([3], dtype = NUMPY_INT_TYPE_PYTHON)    
...
cdef long get_angle_energy_change(int bead_index,
    ...
    cdef cnp.ndarray[NUMPY_INT_TYPE, ndim=2] angle_positions  = np.zeros([5, 3], dtype=NUMPY_INT_TYPE_PYTHON)    
